...
if (isset($_GET['name']) and isset($_GET['password'])) {
    ...
    $res = Model::signup($username, $password);
    if ($res == true) {
        echo "signup-sucess";
    } else {
        echo "signup-error";
...
<body>
    ...
    <div class="card mt-3 mb-5 w-50 mx-auto">
        <div class="card-body">
            <form method="post" id="frm1" action="register.php">
                ...
                <div class="form-group  mt-3">
                    <input type="text" name="number" placeholder="Please Enter Your Number" class="form-control" required>
                </div>

                <div class="form-group mt-3">
                    <input type="password" name="password" placeholder="Please Enter Your Password" class="form-control" id="yourPassword" required>
                </div>

                <div class="form-group mt-3">
                    <button class="btn btn-dark" type="submit" name="reg">Register</button>
                </div>
            </form>
        </div>
    </div>
