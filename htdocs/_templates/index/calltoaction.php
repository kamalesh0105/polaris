  ...
  <div class="row py-lg-5">
    <form method="post" enctype="multipart/form-data" action="index.php">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 id="setcolor" class="text-light"> What are you upto,<?= Session::getuser()->getUsername('auth') ?> ?</h1>
        <p class="lead text-light" id="setcolor">share a photo that talks about it.</p>
